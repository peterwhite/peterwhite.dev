...
- Self Host: NextJS can be self-hosted [with some limitations](https://nextjs.org/docs/deployment). Projects like [OpenNext](https://open-next.js.org) are trying to address these. This could then be hosted with Hetzner (Germany), Scaleway (France), Tilaa (Netherlands) or any other EU-based cloud provider.
