...
- Self Host: NextJS can be self-hosted [with some limitations](https://nextjs.org/docs/deployment). Projects like [OpenNext](https://open-next.js.org) are trying to address these. You can then use an EU hosting provider of your choice.
- Hetzner (Germany): Hetzner offer managed hosting services that are fully compliant with EU data residency requirements. [See more details here](https://www.hetzner.com/cloud?utm_source=peterwhitedev)
- OVH (France): OVH offer managed hosting services that are fully compliant with EU data residency requirements. [See more details here](https://www.ovhcloud.com/en-gb/public-cloud?utm_source=peterwhitedev)
