...
1. Copy the whole mention extension file [from here](https://github.com/ueberdosis/tiptap/blob/main/packages/extension-mention/src/mention.ts)
2. Modify the renderHTML function to swap 'span' for 'a'
3. Add a href to mergeAttributes, using a value from your suggestion function
4. Done!
