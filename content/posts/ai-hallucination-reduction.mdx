...
This allows models to generate responses as a world model emerges through proximity of embeddings. However, when faced with true novelty not represented in these vector patterns, they can't create new solutions, leading to hallucinations.

## Reducing Hallucinations
Here are a few ways I've managed to reduce hallucinations when working with GPT-3, GPT-3.5, GPT-4 and GPT-4O.
